...
if(isset($_POST['save'])){
	if(!isset($_POST['Nama_lengkap']) || !isset($_POST['NISN']) || !isset($_POST['Alamat']) || !isset($_POST['Tempat_tanggal_lahir']) || !isset($_POST['Jenis_kelamin']) || !$_POST['Agama']){
		...
		if($_POST['Jenis_kelamin'] == ""){
			$Jenis_kelamainErr = "Jenis kelamin tidak boleh kosong!";
		}
    if($_POST['Agama'] == ""){
...
<div class="container">
	<form action="" method="post">
		...
		<div class="form-group">
			...
			<input type="NISN" name="NISN" class="form-control" id="inputNISN" maxlength="30" required>
		...
		<div class="form-group">
			...
			<input type="date" name="Tempat_tanggal_lahir" class="form-control" id="inputTempat_tanggal_lahir" maxlength="50" required>
    ...
    <div class="form-group">
			...
			<input type="Agama" name="Agama" class="form-control" id="inputAgama" maxlength="30" minlength="3" required>
