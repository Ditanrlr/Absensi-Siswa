    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="jadwa.php" class="nav-link">
...
<?php 
$Nama_lengkapErr = $NIPErr = $JabatanErr = $AlamatErr = $Tempat_tanggal_lahirErr =  $Jenis_kelaminErr = $AgamaErr = "";
if(isset($_POST['save'])){
	if(!isset($_POST['Nama_lengkap']) || !isset($_POST['NIP']) || !isset($_POST['Jabatan']) || !isset($_POST['Alamat']) || !isset($_POST['Tempat_tanggal_lahir']) ||!isset($_POST['Jenis_kelamin']) ||!$_POST['Agama']){
		...
		if($_POST['Jabatan'] == ""){
			$JabatanErr = "Jabatan tidak boleh kosong!";
		}
		if($_POST['Alamat'] == ""){
    ...
    if($_POST['Jenis_kelamin'] == ""){
			$Jenis_kelaminErr = "Jenis_kelamin tidak boleh kosong!";
		}
		if($_POST['Agama'] == ""){
    ...
    $Jenis_kelamin= $_POST['Jenis_kelamin'];
		...
		$query = "INSERT INTO dataguru (nama_lengkap,NIP,Jabatan,Alamat,Tempat_tanggal_lahir,Jenis_kelamin,Agama) VALUES('$Nama_lengkap', '$NIP', '$Jabatan', '$Alamat', '$Tempat_tanggal_lahir', '$Jenis_kelamin', '$Agama')";
		$query = "UPDATE dataguru SET nama_lengkap='$Nama_lengkap', NIP='$NIP', Jabatan='$Jabatan', Alamat='$Alamat', Tempat_tanggal_lahir='$Tempat_tanggal_lahir', Jenis_kelamin='$Jenis_kelamin', Agama='$Agama' WHERE id=$id";
...
<a href="<?= $WEB_CONFIG['base_url'] ?>dataGuru.php" class="btn btn-warning mb-3">
...
<div class="container">
	<form action="" method="post">
		...
		<div class="form-group">
			...
			<input type="Jabatan" name="Jabatan" class="form-control" id="inputJabatan" value="<?= $data['Jabatan'] ?>" maxlength="30" minlength="3" required>
		...
		<div class="form-group">
			...
			<input type="date" name="Tempat_tanggal_lahir" class="form-control" id="inputTempat_tanggal_lahir" value="<?= $data['Tempat_tanggal_lahir'] ?>" maxlength="40" required>
    ...
    <div class="form-group">
			...
			<input type="Jenis_kelamin" name="Jenis_kelamin" class="form-control" id="inputJenis_kelamin" value="<?= $data['Jenis_kelamin'] ?>" maxlength="30" minlength="3" required>
			<small class="text-danger"><?= $Jenis_kelaminErr == "" ? "":"* $Jenis_kelaminErr" ?></small>
		</div>
		<div class="form-group">
			<label for="inputAgama">Agama</label>
			<input type="Agama" name="Agama" class="form-control" id="inputAgama" value="<?= $data['Agama'] ?>" maxlength="50" required>
