<?php 
$query = "SELECT * FROM datasiswa ORDER BY id DESC";
...
<div class="wrapper">
  ...
  <div class="col-sm-6">
   <h3>DATA SISWA SMAN 6 GARUT</h3>
    </div>

    <a href="<?= $WEB_CONFIG['base_url'] ?>dataSiswa.php?page=add" class="btn btn-primary mb-3">
	<svg width="20px" height="20px" viewBox="0 0 24 24" class="mb-1 m">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <td><?= $data['Agama'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>dataSiswa.php?page=update&id=<?= $data['id'] ?>" class="btn btn-success m-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>dataSiswa.php?page=delete&id='+idn);
