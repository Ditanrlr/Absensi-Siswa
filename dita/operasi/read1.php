<?php 
$query = "SELECT * FROM dataguru ORDER BY id DESC";
...
<body>
<div class="col-sm-6">
   <h4>DATA GURU & STAFF SMAN 6 GARUT</h4>
    </div>

    <a href="<?= $WEB_CONFIG['base_url'] ?>dataGuru.php?page=add" class="btn btn-primary mb-3">
...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <td><?= $data['Jenis_kelamin'] ?></td>
				<td><?= $data['Agama'] ?></td>
				<td>
					<a href="<?= $WEB_CONFIG['base_url'] ?>dataGuru.php?page=update&id=<?= $data['id'] ?>" class="btn btn-success m-1">
...
function alertDelete(idn) {
	$('#deleteButtonModal').attr('href', '<?= $WEB_CONFIG['base_url'] ?>dataGuru.php?page=delete&id='+idn);
