...
<head>
  ...
  <title>LAPORAN ABSENSI SMA NEGERI 6 GARUT</title>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
      ...
      <div class="container-fluid">
          <div class="row">
              ...
              switch ($content) {
                  case 'add':
                      require 'operasi/create2.php';
                      break;
                  case 'delete':
                      require 'operasi/delete2.php';
                      break;
                  case 'update':
                      require 'operasi/update2.php';
                      break;
                  default:
                      require 'operasi/read2.php';
                      break;
              } ?>
              </div>
          </div>
